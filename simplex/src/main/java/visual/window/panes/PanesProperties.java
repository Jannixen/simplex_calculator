...
abstract class PanesProperties {
    ...
    public static final int HEADER_PANE_HEIGHT = (int) (0.25 * WINDOW_HEIGHT);
    ...
    public static final int EQUATIONS_PANE_POSITION_Y = (int) (0.35 * WINDOW_WIDTH);
    public static final int EQUATIONS_PANE_HEIGHT = (int) (0.45 * WINDOW_WIDTH);
